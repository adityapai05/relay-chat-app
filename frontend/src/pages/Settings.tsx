          ...
          {THEMES.map((themeIdx) => (
            <button
              ...
              className={`group flex flex-col items-center gap-1.5 p-2 rounded-lg transistion-colors ${
                themeIdx === theme ? "bg-base-200" : "hover:bg-base-200/50"
              }`}
              onClick={() => setTheme(themeIdx)}
            >
              <div
              ...
              <span className="text-[11px] font-medium truncate w-full text-center">
                {themeIdx.charAt(0).toUpperCase() + themeIdx.slice(1)}
              </span>
            </button>
          ))}
        </div>
              ...
              <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden">
                <div className="px-4 py-3 border-b border-base-300 bg-base-100">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-medium text-sm">Demo D</h3>
